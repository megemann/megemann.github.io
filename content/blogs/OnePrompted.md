...
<div style="display: flex; justify-content: space-between; margin-bottom: 20px;">
  <div style="flex: 1; padding: 10px; background-color: #f8f9fa; margin-right: 10px; border-radius: 5px;">
    <h3 style="color: #000000;">Bad Prompt</h3>
    <p style="color: #000000;">"Translate from python to c++: print('hello world')"</p>
  </div>
  <div style="flex: 1; padding: 10px; background-color: #e6f3ff; margin-right: 10px; border-radius: 5px;">
    <h3 style="color: #000000;">Improved Prompt</h3>
    <p style="color: #000000;">"Translate the following Python code snippet into its C++ equivalent:<br>```python<br>print('hello world')<br>```<br>Ensure the C++ code achieves the same functionality, printing the exact text "hello world" followed by a newline character to the standard output."</p>
  </div>
  <div style="flex: 1; padding: 10px; background-color: #e6ffe6; border-radius: 5px;">
    <h3 style="color: #000000;">Final Model Output</h3>
    <pre style="color: #000000;">#include &lt;iostream&gt;
