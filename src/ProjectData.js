export const ProjectData = [
    ...
    description: "A custom Gen AI model trained to transform vague, ineffective prompts into highly optimized ones using prompt engineering techniques. Built with Vertex AI and Gemini, this project involved data processing from ShareGPT52k, model fine-tuning, and implementation of knowledge distillation and grounding techniques. The model demonstrated an 18% performance improvement in pairwise evaluations against baseline solutions.",
